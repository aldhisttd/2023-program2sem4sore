...
if($_FILES['febook']['name'] != "") {
    ...
    $q = mysqli_query($koneksi,"SELECT file_ebook FROM buku WHERE isbn='$fIsbn'");
...
mysqli_query($koneksi, "UPDATE buku SET isbn='$fIsbn', judul='$judul', kategori='$kategori' , stok='$stok' WHERE isbn='$fIsbn'");
