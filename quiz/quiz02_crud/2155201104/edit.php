...
<body>
    ...
    $kode = $_REQUEST['kode'];
    $q = mysqli_query($koneksi, "SELECT * FROM quiz2 WHERE isbn='$kode'");
    ...
    <form action="proses/ex_edit.php" method="POST" enctype="multipart/form-data">
        ...
        <select name="fkategori" id="">
            <option value="novel" <?php if ($ary['kategori'] == 'novel') {
                                        echo 'selected="selected"';
                                    } ?>>Novel</option>
            <option value="komik" <?php if ($ary['kategori'] == 'komik') {
                                        echo 'selected="selected"';
                                    } ?>>Komik</option>
            <option value="kamus" <?php if ($ary['kategori'] == 'kamus') {
                                        echo 'selected="selected"';
                                    } ?>>Kamus</option>
        </select>
        <br>
