...
$pilih = mysqli_query($koneksi, "SELECT * FROM software WHERE sn='$sn'");
...
if (isset($_POST['edit'])) {
    ...
    mysqli_query($koneksi, "UPDATE software SET tanggal_rilis='$tgl_rilis', jenis='$jenis', quantity='$quan', spesifikasi='$spek' WHERE kode='$kode'");
            ...
            <tr>
                ...
                <td>
                    <select name="jenis" id="jenis" required>
                        <option value="opensource" <?php if ($row['jenis'] == 'opensource') {
                                                    echo 'selected="selected"';
                                                } ?>>open source</option>
                        <option value="closesource" <?php if ($row['jenis'] == 'closesorce') {
                                                    echo 'selected="selected"';
                                                } ?>>close source</option>
                    </select>
                </td>
